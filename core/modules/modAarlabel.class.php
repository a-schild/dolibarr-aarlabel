...
/**
 * 	\defgroup	aarlabel	Aarlabel module
 ...
 */
class modAarlabel extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		// (where XXX is value of numeric property 'numero' of module)
		$this->description = "Label printing solution Aarlabel";
		...
		$this->picto = 'aarlabel@aarlabel'; // mypicto@aarlabel
		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /aarlabel/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /aarlabel/core/modules/barcode)
		// for specific css file (eg: /aarlabel/css/aarlabel.css.php)
		$this->module_parts = array(
			...
			//'css' => array('aarlabel/css/mycss.css.php'),
			// Set this to relative path of js file if module must load a js on all pages
			// 'js' => array('aarlabel/js/aarlabel.js'),
		...
		// Example: this->dirs = array("/aarlabel/temp");
		$this->dirs = array();

		// Config pages. Put here list of php pages
		// stored into aarlabel/admin directory, used to setup module.
		$this->config_page_url = array("admin_aarlabel.php@aarlabel");
		...
		// Language files list (langfiles@aarlabel)
		$this->langfiles = array("aarlabel@aarlabel");
		// Constants
		...
		$this->tabs = array(
			...
			//	'objecttype:+tabname1:Title1:langfile@aarlabel:$user->rights->aarlabel->read:/aarlabel/mynewtab1.php?id=__ID__',
			//	// To add another new tab identified by code tabname2
			//	'objecttype:+tabname2:Title2:langfile@aarlabel:$user->rights->othermodule->read:/aarlabel/mynewtab2.php?id=__ID__',
		...
		// Dictionaries
		if (! isset($conf->aarlabel->enabled)) {
			$conf->aarlabel=new stdClass();
			$conf->aarlabel->enabled = 0;
		}
		$this->dictionaries = array();
		/* Example:
		  // This is to avoid warnings
		  if (! isset($conf->aarlabel->enabled)) $conf->aarlabel->enabled=0;
		  $this->dictionaries=array(
			  'langs'=>'aarlabel@aarlabel',
		...
		//	'titre'=>'Aarlabel top menu',
		// This menu's mainmenu ID
		//	'mainmenu'=>'aarlabel',
		// This menu's leftmenu ID
		//	'leftmenu'=>'aarlabel',
		//	'url'=>'/aarlabel/pagetop.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
		//	// Define condition to show or hide menu entry.
		//	// Use '$conf->aarlabel->enabled' if entry must be visible if module is enabled.
		//	'enabled'=>'$conf->aarlabel->enabled',
		//	// Use 'perms'=>'$user->rights->aarlabel->level1->level2'
		...
		//	'type'=>'left',
		// Menu's title. FIXME: use a translation key
		//	'titre'=>'Aarlabel left menu',
		// This menu's mainmenu ID
		//	'mainmenu'=>'aarlabel',
		// This menu's leftmenu ID
		//	'leftmenu'=>'aarlabel',
		//	'url'=>'/aarlabel/pagelevel1.php',
		//	// Lang file to use (without .lang) by module.
		//	// File must be in langs/code_CODE/ directory.
		//	'langs'=>'mylangfile',
		//	'position'=>100,
	 ...
	 * and create data commands must be stored in directory /aarlabel/sql/
	...
	{
		//return $this->_load_tables('/aarlabel/sql/');
            return 0;
	}
}
